...
_mldb() {
    ...
    local ml_commands_a_m="attach audiocapture audioplayer battery capture crashdump date getprop get-devpath get-name install launch log"
    local ml_commands_n_z="packages perf provision ps reset-headpose rtsp-token setprop shutdown terminate top uninstall"
