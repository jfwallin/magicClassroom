...
/*!
  ...
  This will automatically release any #MLFileInfo pointers contained, thus #MLFileInfoRelease
  must not be called as doing so will cause undefined behavior.
