...
/*! #MLInvokeMethod is the type of a user-supplied method that will be called asynchronously. */
...
/*! #MLCallbackMethod is the type of the user-supplied completion callback. */
