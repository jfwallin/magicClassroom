...
/*!
  ...
  \priv None
*/
ML_API void ML_CALL MLLoggingEnableLogLevel(MLLogLevel level);
...
/*!
  ...
  \priv None
*/
ML_API bool ML_CALL MLLoggingLogLevelIsEnabled(MLLogLevel level);
...
/*!
  ...
  \priv None
*/
ML_API void ML_CALL MLLoggingLogVargs(MLLogLevel level, const char *tag, const char *fmt, ...) ML_PRINTF_ATTRIBUTE(3, 4);
...
/*!
  ...
  \priv None
*/
ML_API void ML_CALL MLLoggingLog(MLLogLevel level, const char *tag, const char *message);
