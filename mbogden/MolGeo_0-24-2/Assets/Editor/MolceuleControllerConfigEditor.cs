...
public class MolceuleControllerConfigEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        configFile.vibPattern = (MLInput.Controller.FeedbackPatternVibe)EditorGUILayout.EnumPopup("Controller Vibration Pattern", configFile.vibPattern);
        configFile.vibIntensity = (MLInput.Controller.FeedbackIntensity)EditorGUILayout.EnumPopup("Vibration Intensity", configFile.vibIntensity);
    }
}
