...
namespace MtsuMLAR
{
    public class Molecule_Controller : MonoBehaviour, IMLPointerEnterHandler, IMLPointerExitHandler, IMLSelectHandler, IMLDeselectHandler, IMLBeginDragHandler, IMLDragHandler
    {
        ...
        void ToggleRotation(byte controllerId, MLInput.Controller.TouchpadGesture touchpadGesture)
        {
            //The only way to start a rotation is by pressing on the touchpad
            if (touchpadGesture.Type == MLInput.Controller.TouchpadGesture.GestureType.ForceTapDown)
            {
        ...
        /// <param name="controllerId"></param>
        /// <param name="touchpadGesture"></param>
        void ToggleDepth(byte controllerId, MLInput.Controller.TouchpadGesture touchpadGesture)
        {
