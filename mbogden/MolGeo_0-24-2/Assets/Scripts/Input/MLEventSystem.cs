    ...
    public class MLEventSystem : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (!isDragging)
            {
                ...
                {
                    _controller.StartFeedbackPatternVibe(MLInput.Controller.FeedbackPatternVibe.Bump, MLInput.Controller.FeedbackIntensity.Low);
        ...
        public void ControllerButtonDownHandler(byte controllerID, MLInput.Controller.Button button)
        {
            //Some controller validation, and making sure the event is from the bumper, else we don't do anything
            if (_controller != null && _controller.Id == controllerID && button == MLInput.Controller.Button.Bumper)
            {
                UpdateEventData(eventData);
        ...
        void ControllerButtonUpHandler(byte controllerID, MLInput.Controller.Button button)
        {
