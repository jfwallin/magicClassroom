                ...
                if (checkAnswer && !needToResetBox && !resetCoroutineRunning)
                {
                    ...
                    if (triggeredPlatformGeometry == answerKey[currentQuestionNumber])
                    {
                        ...
                        MLInput.GetController(MLInput.Hand.Left).StartFeedbackPatternEffectLED(
                            MLInput.Controller.FeedbackEffectLED.Blink,
                            MLInput.Controller.FeedbackEffectSpeedLED.Medium,
                            MLInput.Controller.FeedbackPatternLED.None,
                            MLInput.Controller.FeedbackColorLED.BrightShaggleGreen,
                            0.5f);
                        MLInput.GetController(MLInput.Hand.Left).StartFeedbackPatternVibe(
                            MLInput.Controller.FeedbackPatternVibe.Tick,
                            MLInput.Controller.FeedbackIntensity.Low);
                        needToResetBox = true;
                        numCorrect++;
                    }
                    ...
                    else if (incorrectPlayed != true)
                    {
                        ...
                        MLInput.GetController(MLInput.Hand.Left).StartFeedbackPatternEffectLED(
                            ...
                            MLInput.Controller.FeedbackEffectSpeedLED.Medium,
                            MLInput.Controller.FeedbackPatternLED.None,
                            MLInput.Controller.FeedbackColorLED.BrightMissionRed,
                            0.5f);
                        MLInput.GetController(MLInput.Hand.Left).StartFeedbackPatternVibe(
                            MLInput.Controller.FeedbackPatternVibe.Buzz,
                            MLInput.Controller.FeedbackIntensity.Medium);
